...
output "service_name" {
  ...
  value       = google_cloud_run_v2_service.gen_ai_service.name
}

output "service_url" {
  description = "The URL of the Cloud Run service"
  value       = google_cloud_run_v2_service.gen_ai_service.uri
}
...
output "artifact_repository" {
  ...
  value       = google_artifact_registry_repository.gen_ai_repo.repository_id
}
